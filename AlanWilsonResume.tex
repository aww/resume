...
\cvitemwithcomment{\footnotesize machine learning}{supervised learning, boosted decision trees (BDTs)}{paper: training BDTs with weighted events}
...
\cvitemwithcomment{\small indep. study}{Andrew Ng's machine learning, Bill Howe's data science, etc.}{Coursera courses}
